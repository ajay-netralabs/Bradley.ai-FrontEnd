...
const SubStep2: React.FC = () => { 
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', p: 1, pr: 4, pl: 1, pt: 1 }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 0 }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '150px', flex: 0.25 }}><b>Hot Water Usage:</b></Typography>
          <TextField
            variant="outlined" 
            size="small" 
            type="number" 
          ...
          >
            <MenuItem value="Option 1" sx={{fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem',}}>Gallons (Default)</MenuItem>
            <MenuItem value="Option 2" sx={{fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem',}}>BTUs</MenuItem>
          </Select>
        </Box>
  ...
  <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '150px', flex: 0.25 }}>
    <b>Hot Water Usage Type in Gallons:</b> (Optional)
  </Typography>
</Box>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <TextField
            ...
            size="small" 
            type="number"
            placeholder='Annual Usage (Gallons)' 
            sx={{
              flex: 0.75, fontFamily: 'Nunito Sans, sans-serif',
              fontSize: '0.7rem',
              '& .MuiInputBase-root': { height: '24px', padding: '0 6px' },
