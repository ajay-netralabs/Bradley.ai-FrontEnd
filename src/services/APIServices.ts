...
// Facility Address
export const updateFacilityAddresses = async (data: AddressPayload[]): Promise<AddressUpdateResponse | null> => {
    try {
...
// Bill Upload
export const uploadBillData = async (Files: File[], sources: string[], uuids: string[]): Promise<DashboardData | null> => {
    try {
