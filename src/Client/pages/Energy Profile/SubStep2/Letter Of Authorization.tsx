...
const SubStep3: React.FC = () => {
  ...
  const facilityAddressState = useAppSelector((state) => state.organizationalProfile.facilityAddress);
  ...
  const handleUpdateLOAField = (field: keyof LOAFormState, value: string | boolean) => {
      dispatch(updateLOAField({ field, value }));
  };

  const handleUpdateNestedLOAField = (section: 'textFields' | 'contactDetails', field: string, value: string) => {
      dispatch(updateLOANestedField({ section, field, value }));
  };
  ...
  const handleDayChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (/^\d*$/.test(value)) {
      ...
      if (value === '' || (numValue >= 1 && numValue <= 31)) {
        handleUpdateNestedLOAField('textFields', 'day', value);
      }
    }
  };
  ...
  const handleMonthChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value === '' || monthNames.some(name => name.startsWith(formattedValue))) {
       handleUpdateNestedLOAField('textFields', 'month', value);
    }
  };
  ...
  const handleSignatureChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (/^[a-zA-Z\s]*$/.test(value)) {
      handleUpdateLOAField('signature', value);
    }
  };
  ...
  const handleAddressFieldUpdate = (field: string, value: string) => {
    if (currentAddress?.id) {
        // @ts-ignore
      dispatch(updateAddressField({ id: currentAddress.id, field, value }));
    }
  };
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 0 }}>
        <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', pl: '160px', pr: '160px' }}>
          <Box sx={{ alignItems: 'center', gap: 1 }}>
            ...
            <TextField fullWidth variant="outlined" size="small" placeholder="Utility Company Name" value={utilityCompanyName} onChange={(e) => handleUpdateLOAField('utilityCompanyName', e.target.value)} sx={{ mb: 2, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
            ...
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', mt: 3, textAlign: 'justify', lineHeight: 1.8 }}>
              ...
              , 2025, the{' '}<TextField variant="standard" type="text" placeholder="(CUSTOMER NAME)" value={customerNameDisplay} onChange={(e) => dispatch(updateOrganizationDetails({ organizationName: e.target.value.split(',')[1]?.trim(), userName: e.target.value.split(',')[0]?.trim() }))} sx={{ width: '150px', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { padding: 0, marginBottom: '-2px' }, '& input': { textAlign: 'center', fontSize: '0.8rem', padding: 0 }, '& .MuiInputBase-input::placeholder': { fontSize: '0.7rem' } }} />
              ...
              . Customer Point of Contact is Mr./Mrs.{' '}<TextField variant="standard" type="text" placeholder="(NAME)" value={textFields.contactName} onChange={(e) => handleUpdateNestedLOAField('textFields', 'contactName', e.target.value)} sx={{ width: '120px', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { padding: 0, marginBottom: '-2px' }, '& input': { textAlign: 'center', fontSize: '0.8rem', padding: 0 }, '& .MuiInputBase-input::placeholder': { fontSize: '0.7rem' } }} />
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center', mt: 3 }}>
            ...
            <TextField fullWidth variant="outlined" size="small" type="text" placeholder='Customer / Company Name Here' value={customerNameDisplay} onChange={(e) => dispatch(updateOrganizationDetails({ userName: e.target.value.split(',')[0]?.trim(), organizationName: e.target.value.split(',')[1]?.trim() || '' }))} sx={{ flex: 0.5, fontSize: '0.7rem', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '150px', flex: 0.25 }}><b>Service Address:</b></Typography>
            <TextField fullWidth variant="outlined" size="small" type="text" placeholder='1212 USA Lane' value={contactDetails.serviceAddress} onChange={(e) => handleUpdateNestedLOAField('contactDetails', 'serviceAddress', e.target.value)} sx={{ flex: 0.5, fontSize: '0.7rem', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center' }}>
            ...
            <TextField fullWidth variant="outlined" size="small" type="tel" placeholder='Enter Contact No. Here' value={contactDetails.phoneNo} onChange={(e) => handleUpdateNestedLOAField('contactDetails', 'phoneNo', e.target.value)} sx={{ flex: 0.5, fontSize: '0.7rem', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center' }}>
            ...
            <TextField fullWidth variant="outlined" size="small" placeholder='Enter Email Here' type="email" value={userEmail} onChange={(e) => dispatch(updateOrganizationDetails({ userEmail: e.target.value }))} sx={{ flex: 0.5, fontSize: '0.7rem', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', minWidth: '150px', flex: 0.25 }}><b>Service Acc. No.:</b></Typography>
            <TextField fullWidth variant="outlined" size="small" type="number" placeholder='12345678910111213' value={contactDetails.serviceAccountNo} onChange={(e) => handleUpdateNestedLOAField('contactDetails', 'serviceAccountNo', e.target.value)} sx={{ flex: 0.5, fontSize: '0.7rem', fontFamily: 'Nunito Sans, sans-serif', '& .MuiInputBase-root': { height: '24px', padding: '0 6px' }, '& input': { padding: 0, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.8rem' }, '& .MuiInputBase-input::placeholder': { fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.7rem' } }} />
          </Box>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: 'center' }}>
            ...
            <Button variant="outlined" onClick={() => handleUpdateLOAField('signature', '')} sx={{ flex: 0.24, fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.65rem', padding: '2px 1px', pr: '15px', pl: '15px', alignSelf: 'flex-end', textTransform: 'none', '&:focus': { outline: 'none' } }}>
              Clear Signature
            </Button>
          </Box>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: 'flex-start', mt: 1 }}>
            <Checkbox checked={agreed} onChange={(e) => handleUpdateLOAField('agreed', e.target.checked)} sx={{ padding: '0 0', '& .MuiSvgIcon-root': { fontSize: '1.1rem' } }} />
