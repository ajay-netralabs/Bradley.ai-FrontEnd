  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', p: 1, pr: 4, pl: 1, pt: 1 }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pt: '10px', pb: '10px', px: '160px' }}>
        ...
        {showMap && (
          <Box sx={{ mb: 2 }}>
            <Typography sx={{ fontFamily: 'Nunito Sans, sans-serif', fontSize: '0.75rem', mb: 1 }}><b>Instructions:</b> Use the polygon or rectangle tools to select areas for solar installation. The selected area will automatically update the land area field above.</Typography>
