...
const stepSubStepMapping: StepSubStepMapping = {
  ...
  1: {
    ...
    1: {
      0: lazy(() => import('./pages/Energy Profile/SubStep2/Energy Load Profile')),
      1: lazy(() => import('./pages/Energy Profile/SubStep2/Thermal Energy Needs - I')),
      2: lazy(() => import('./pages/Energy Profile/SubStep2/Thermal Energy Needs - II')),
      3: lazy(() => import('./pages/Energy Profile/SubStep2/Thermal Energy Needs - III')),
      4: lazy(() => import('./pages/Energy Profile/SubStep2/Thermal Energy Needs - IV')),
      5: lazy(() => import('./pages/Energy Profile/SubStep2/Existing Boiler Cogeneration')),
      6: lazy(() => import("./pages/Energy Profile/SubStep2/Don't Have Interval Electric Load Data")),
    },
    2: {
